...
class material {
 public:
  ...
  scatter(const ray& r_in, const hit_record& rec, vec3& attenuation, ray& scattered, curandState* r_state) const = 0;
};
...
class lambertian : public material {
 public:
  ...
  __device__ virtual bool scatter(
      ...
      vec3& attenuation,
      ray& scattered,
      curandState* r_state) const override {
    vec3 scatter_direction =  rec.normal + random_in_unit_sphere(r_state, false);
...
class metal : public material {
 public:
  ...
  __device__ virtual bool scatter(
    ...
    reflected += fuzz * random_in_unit_sphere(r_state);
...
class dielectric : public material {
 public:
  ...
  __device__ virtual bool scatter(
    ...
    vec3 direction;
    if (cannot_refract || reflectance(cos_theta, refraction_ratio) > curand_uniform(r_state))
